        ...
        <div style="flex: 2; padding-right: 20px;">
            ...
            <div
                ...
                <div style="color: black; font-size: 32px; font-family: Roboto; font-weight: 700; margin-top: 10px;">
                    Begini cara mencerahkan kulit secara alami berikut ini!
                </div>
                <div
                    style="color: black; font-size: 16px; font-family: Times New Roman; font-weight: 400; margin-top: 20px; line-height: 1.6;">
                    <br> Untuk mencerahkan kulit secara alami, ada beberapa metode yang bisa dilakukan tanpa menggunakan
                    bahan kimia
                    berbahaya. Pertama, menjaga kebersihan kulit dengan rutin membersihkan wajah, agar kotoran dan
                    minyak tidak
                    menumpuk dan menyebabkan kulit kusam. Kedua, gunakan bahan-bahan alami seperti bengkoang, lemon,
                    atau madu
                    yang diketahui memiliki manfaat untuk mencerahkan kulit. Selain itu, menjaga pola makan yang sehat
                    dengan
                    banyak mengonsumsi buah dan sayuran, serta cukup minum air putih, juga berperan penting dalam
                    menjaga kulit
                    tetap cerah dan sehat. Jangan lupa untuk selalu menggunakan tabir surya saat beraktivitas di luar
                    ruangan
                    untuk melindungi kulit dari paparan sinar UV yang dapat menyebabkan kulit gelap.</br>
            ...
            <div
                ...
                <a href="<?= base_url('artikel2') ?>" style="text-decoration: none; color: inherit;">
                    <div style="display: flex; gap: 15px; margin-top: 20px;">
                        ...
                        <div>
                            <div style="font-size: 14px; color: black; margin-bottom: 8px;">12 Juni 2024</div>
                ...
                <a href="<?= base_url('artikel3') ?>" style="text-decoration: none; color: inherit;">
                    <div style="display: flex; gap: 15px; margin-top: 20px;">
                        ...
                        <div>
                            <div style="font-size: 14px; color: black; margin-bottom: 8px;">25 Agust 2024</div>
                ...
                <a href="<?= base_url('artikel4') ?>" style="text-decoration: none; color: inherit;">
                    <div style="display: flex; gap: 15px; margin-top: 20px;">
                        ...
                        <div>
                            <div style="font-size: 14px; color: black; margin-bottom: 8px;">30 Agust 2024</div>
