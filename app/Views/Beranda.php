...
<div class="HalamanBeranda" style="width: 1440px; height: 4464px; position: relative">
  ...
  <div class="bgAktifitas" style="width: 1361px; height: 392px; left: 39px; top: 3295px; position: absolute; background: #E2CEB1; border-radius: 25px"></div>
  ...
  <div class="Vector produk" style="width: 1440px; height: 250px; left: 0px; top: 3000px; position: absolute; background: rgba(250, 229, 198, 0.80)"></div>
  ...
  <img class="citra" style="width: 259px; height: 300px; left: 210px; top: 1959px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px" src="uploads/citra.png" />
  <div class="Group109" style="width: 310px; height: 344px; left: 1010px; top: 2335px; position: absolute">
    ...
    <img class="ovale" style="width: 267px; height: 300px; left: 0px; top: 44px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px" src="uploads/ovale.png" />
  </div>
  <div class="Group108" style="width: 326px; height: 374px; left: 163px; top: 2767px; position: absolute">
    ...
    <img class="pelembab" style="width: 277px; height: 300px; left: 49px; top: 29px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px" src="uploads/pelembab.png" />
  </div>
  <div class="Group80" style="width: 1443px; height: 881px; left: -3px; top: 895px; position: absolute">
    ...
    <div class="Group62" style="width: 406px; height: 291.77px; left: 151px; top: 324px; position: absolute">
      <img class="gdesk1" style="width: 308.94px; height: 170.08px; left: 0px; top: 0px; position: absolute; border-radius: 15px" src="uploads/gambardes1.png" />
      <img class="gdesk2" style="width: 261.32px; height: 190.82px; left: 144.68px; top: 100.94px; position: absolute; border-radius: 15px" src="uploads/gambardes2.png" />
    </div>
    ...
    <div class="Vector" style="width: 1439px; height: 150px; left: 4px; top: -150px; position: absolute; background: #B6A99B"></div>
  ...
  <img class="influencer" style="width: 200px; height: 285px; left: 805px; top: 3492px; position: absolute" src="uploads/influe.png" />
  <img class="Testi" style="width: 266px; height: 296px; left: 60px; top: 3485px; position: absolute" src="uploads/testi.png" />
  ...
  <img class="uji" style="width: 230px; height: 277px; left: 436px; top: 3504px; position: absolute" src="uploads/uji.png" />
  <img class="promo" style="width: 231px; height: 265px; left: 1130px; top: 3492px; position: absolute" src="uploads/promo.png" />
  ...
  <div class="Group100" style="width: 1440px; height: 335px; left: 0px; top: 4129px; position: absolute">
    <div class="Frame307" style="width: 1440px; height: 335px; left: 0px; top: 0px; position: absolute; justify-content: center; align-items: center; display: inline-flex">
      <div class="Group99" style="width: 1440px; height: 335px; position: relative">
        ...
        <img class="Telp" style="width: 28px; height: 19px; left: 1029px; top: 109px; position: absolute" src="uploads/Ringer Volume.png" />
        <img class="Pesan" style="width: 28px; height: 19px; left: 1029px; top: 141px; position: absolute" src="uploads/letter.png" />
        <img class="Twitter" style="width: 45px; height: 40px; left: 1102px; top: 205px; position: absolute" src="uploads/twitter.png" />
        <img class="Facebook" style="width: 45px; height: 40px; left: 1057px; top: 206px; position: absolute" src="uploads/link.png" />
        <img class="Instagram" style="width: 45px; height: 40px; left: 1147px; top: 206px; position: absolute" src="uploads/instagram.png" />
        <img class="Youtube" style="width: 45px; height: 40px; left: 1192px; top: 206px; position: absolute" src="uploads/youtube.png" />
    ...
    <div class="Group99" style="width: 903px; height: 263px; left: 68px; top: 23px; position: absolute">
      ...
      <img class="Letter" style="width: 28px; height: 19px; left: 20px; top: 170px; position: absolute" src="uploads/Letter.png" />
