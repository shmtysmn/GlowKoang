...
<div class="Aktifitas" style="width: 1440px; height: 1000px; position: relative; background: white">
  ...
  <img class="fotouji" style="width: 317px; height: 408px; left: 989px; top: 536px; position: absolute" alt="gambar uji" src="uploads/promo.png" />
  <div class="UjiKelayakanProduk" style="width: 536px; height: 58px; left: 159px; top: 536px; position: absolute; text-align: justify; color: black; font-size: 45px; font-family: Poppins; font-weight: 500; line-height: 57.60px; word-wrap: break-word">Promo Produk</div>
 </div>
  </div>
  </div>
