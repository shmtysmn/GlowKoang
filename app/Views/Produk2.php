...
<body>
  ...
  <img class="RemovebgPreview" style="width: 258px; height: 369px; left: 154px; top: 391px; position: absolute; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px" alt="gambar citra" src="uploads/ovale.png" />
  <div class="ovale" style="left: 542px; top: 376px; position: absolute; color: black; font-size: 45px; font-family: Poppins; font-weight: 400; line-height: 57.60px; word-wrap: break-word">Ovale Bengkoang</div>
